...
public class StaticDemo {
    ...
    static int y; // статическая переменная // все объекты используют одну и ту же копию стат переменной
    // возвратить сумму значений переменной экземпляра x и стат переменной y
    int sum() {
        return  x + y;
    }
}
class SDemo {
    public static void main(String[] args) {
        ...
        StaticDemo.y = 19;
        System.out.println("Присвоить StatiсDemo.y значение 19");
