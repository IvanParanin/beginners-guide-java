...
public class AutoBox3 {
    public static void main(String[] args) {
        ...
        int i;
        iOb = 99;
        System.out.println("Исходящее значение iOb: " + iOb);
        ...
        /* Выполняется автораспаковка объекта iOb,
        производятся вычисления, а результат снова упаковывается в объект iOb.
         */
        iOb2 = iOb + (iOb / 3);
        System.out.println("iOb2 после вычисления выражения: " + iOb2);

        /* Вычисляется то же самое выражение, но
        повторная упаковка не выполняется.
         */
        i = iOb + (iOb / 3);
