...
class LambdaArgumentDemo {
    ...
    public static void main(String[] args) {
        ...
        /* Определите лямбда-выражение, располагающее содержимое строки
        в обратном порядке, и присвойте его переменной,
        ...
        /* Данное лямбда-выражение засеняет пробелы дефисами.
        ...
        букв в строке. Оно также внедряется непосредственно в вызов метода changeStr()
         */
